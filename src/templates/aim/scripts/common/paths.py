#!/usr/bin/env python3
"""
Common path utilities for AIM Studio workflow.
...
def get_repo_root(start_path: Path | None = None) -> Path:
    """Find the nearest directory containing .aim-studio/ folder.
    ...
    Returns:
        Path to repository root, or current directory if no .aim-studio/ found.
    """
    ...
    # Fallback to current directory if no .aim-studio/ found
