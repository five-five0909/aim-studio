...
Example: python3 start.py .aim-studio/tasks/01-21-my-task
...
Configuration: .aim-studio/worktree.yaml
"""
...
def main() -> int:
    ...
    cli_cmd = adapter.build_run_command(
        agent="dispatch",
        prompt="Follow your agent instructions to execute the task workflow. Start by reading .aim-studio/.current-task to get the task directory, then execute each action in task.json next_action array in order.",
